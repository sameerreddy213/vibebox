                ...
                <div className="flex w-full md:w-2/3 lg:w-1/2 flex-col sm:flex-row mx-auto items-stretch gap-4">
                    <div className="relative flex-grow w-full">
                        <input
                            ...
                            className="w-full bg-white/10 backdrop-blur-md rounded-full border border-white/10 focus:border-[#1db954] focus:ring-1 focus:ring-[#1db954] text-base outline-none text-white py-3 px-6 leading-8 transition-colors duration-200 ease-in-out placeholder-gray-400 shadow-lg"
                        />
                    </div>
                    <button
                        id="searchBtn"
